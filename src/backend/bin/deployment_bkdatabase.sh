...
echo "--------------------------------------------------------------------------------"
echo "Back up DB from source: facilities, classes, events, countries, states, users, photos, photoviewlogs"
echo "--------------------------------------------------------------------------------"
...
mongodump --host $SOURCE --db ScrapingData --collection photoviewlogs --out $DIR/dump
